...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_fill_2eproto);
}
...
void protobuf_AddDesc_fill_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_fill_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_fill_2eproto {
  StaticDescriptorInitializer_fill_2eproto() {
    protobuf_AddDesc_fill_2eproto();
  }
} static_descriptor_initializer_fill_2eproto_;
...
const Fill& Fill::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_fill_2eproto();  return *default_instance_;
}
